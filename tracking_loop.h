...
struct Track {
    ...
    int cls;
    bool has_color_descriptor = false;
    bool has_grayscale_descriptor = false;
};
...
public:
    ...
    // Retrieve descriptor (color or grayscale) for a given track
    bool getDescriptor(int id, TrackDescriptor& out) const;
