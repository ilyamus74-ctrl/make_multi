...
private:
    ...
    void setupCameraIntrinsics(const CameraConfig&, CameraCalibration&);
    void setupSphereExtrinsics(const CameraConfig&, CameraCalibration&, double, double);
    void setupHemisphereExtrinsics(const CameraConfig&, CameraCalibration&, double, double);
    void setupZoomExtrinsics(const CameraConfig&, CameraCalibration&);
